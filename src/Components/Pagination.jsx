...
const Pagination = () => {
  ...
  return (
    <div className='class="fixed bottom-0 inset-x-0 bg-white py-2 border-t-2 border-t-gray-300 w-full mt-[-75px]'>
      <div className='flex items-center gap-x-3 w-11/12 max-w-2xl mx-auto'>
        ...
        <p className='text-sm font-semibold ml-auto flex gap-1'>page <p className='font-bold'>{page}</p> of {totalPages}</p>
      </div>
    </div>
  )
}
